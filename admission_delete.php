...
<form id="signupform" name="signupform" method="post" action="admission_delete.php";>
...
$sql1 = "DELETE  FROM admission WHERE id='$id'";
...
<div id="footer">
<ul class="pager">
    <li><a href="admission_details.php"><b><big>Previous</big><b></a></li>
