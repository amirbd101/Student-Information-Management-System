...
<div  id="p">
<p style="color: #A81726"><h2><b> Semester </b></h2><p>
</div>
<div id="form" >
<form id="signupform" name="signupform" method="post" action="semester_insert.php";>
...
<td><input name="semesterid" id="name" type="text">
</td>
</tr>
