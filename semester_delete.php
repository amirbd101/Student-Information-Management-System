...
<form id="signupform" name="signupform" method="post" action="semester_delete.php";>
...
$sql1 = "DELETE  FROM semester WHERE id='$id'";
...
<div id="footer">
<ul class="pager">
    <li><a href="semester_details.php"><b><big>Previous</big><b></a></li>
